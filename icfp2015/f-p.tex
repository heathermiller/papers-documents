...
and optimization. Some such problems include:

\begin{itemize}

\item These systems' APIs cannot statically prevent {\em common usage errors}.
As a result, users are often confronted with runtime errors that are hard to
debug. A common example is unsafe closure serialization~\cite{Spores}.
...
Type-safe distributed programming in ML5 (Tom 7)~\cite{Tom7}
