...
\url{http://lampwww.epfl.ch/~hmiller/f-p/}\footnote{Review note: this site is publicly accessible, has no tracking capabilities, and is linked to in talks and from other various webpages meaning it already gets public traffic. One may visit it without identity concerns.}
