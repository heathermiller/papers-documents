...
Twitter, have established their competitive offerings by way of one or both of
these types of systems.

Microservices are small independent (separately-compiled) services which
communicate with each other using language-agnostic APIs. ``Big data''-style
applications typically are those which assume.

The trend is called ``microservices'' and a piece of software that a user
might perceive as a single piece of software might be made up of dozens of
such microservices--complex applications are composed of small, independent
