...
The most successful systems for ``big data'' processing all Functional ideas have long
been appearing in the designs of such systems.
But the innards of these systems are often built atop mutable, weakly-typed stacks, and as a result complicating essentials like fault-tolerance.
 We present a new programming
...
We aim to add reason to this calamity.


Our principal contributions are a careful selection of features that support
