...
Our model can be thought of as somewhat of a dual to the actor
...
An important goal of our model is to better understand programming systems
such as Spark, Scalding, and Scoobi, by incorporating several of their core
principles; namely, immutable distributed data and distributed closure
passing. At the same time, the prototype implementation of our programming
model is much simpler as compared to such systems. As a result, our prototype
simplifies experimentation and exploring implementation trade-offs. In
addition, the simplicity of our programming model enables capturing the
semantics of core constructs more precisely.

In particular, one important goal is to more precisely specify the semantics
of widespread fault-recovery mechanisms based on the concept of a {\em
lineage}. Essentially, the lineage of a data set combines (a) an initial data
...
recovery through recomputing results.
