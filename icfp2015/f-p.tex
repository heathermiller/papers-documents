...
functional programming. Interestingly, we found that laziness was an enabler
in our model, without complicating the ability to reason about programs.
Without optimizations based on laziness, we found this model would be
