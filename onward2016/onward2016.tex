...
available on GitHub~\footnote{Omitted for review due to double blind criterion.}

In the context of MBrace, we also implemented the K-Means Clustering example
available on the MBrace's
website\footnote{http://mbrace.io/starterkit/HandsOnTutorial/examples/200-kmeans-clustering-example.html},
...
The design leading up to the function passing model has incorporated many similar ideas, such as
...
as a remote invocation (pickling arguments and result appropriately). In the function passing model,
