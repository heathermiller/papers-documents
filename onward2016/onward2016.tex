...
% XXX @heater, @philip: Don't get XeTeX/ LuaTeX running
%\usepackage{fontspec}
...
% XXX @heater, @philip: Running pdflatex I get the following warings:
%
...
% XXX Requires XeTeX/ LuaTeX
% XXX \setmainfont[Mapping=tex-text]{Times New Roman}
% XXX \setmonofont[Scale=0.8,BoldFont={Consolas Bold}]{Consolas}
...
\begin{figure}[t!]
\centering\includegraphics[width=\columnwidth]{pic/multiJVM.pdf}
