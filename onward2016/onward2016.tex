...
a {\emph{silo reference proxies}}, delegating to the actual data. I.e., the 
anonymous silo reference created at \verb|m2| will not be ruled out but function 
as proxy delegating requests re \verb|owners| to the data hosted at \verb|m3|. 
This alleviates network communication and scales up transformation execution.  
...
here mention theses constituents of a SiloRef?} The \verb|fromLineage| method is 
