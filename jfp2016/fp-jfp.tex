...
\begin{abstract}
  ...
  which to build data-centric distributed systems. A key idea is to build up a
...
Our programming model which we call {\em\FP} can be thought of a programming model
for middleware, meant to underly systems like Spark. \FP adopts the concept of a 
...
represents a {\em directed acyclic graph} (DAG) of functional transformations on 
distributed data. The root node contains immutable data read from stable storage 
