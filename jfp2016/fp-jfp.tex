...
\title[Journal of Functional Programming]{A Programming Model and Foundations for Lineage-Based Distributed Computation}
...
\author[H. Miller, P. Haller and N. M{\"u}ller]{%
  ...
  NORMEN M{\"U}LLER\\ Trivadis GmbH, Germany}%\\ \email{normen.mueller@trivadis.com}}
...
materialized in memory. \comment{{\color{gray}The value type \verb|Unit| ensures no data is
