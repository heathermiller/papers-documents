...
data structure representing a history of the operation performed on some data, rather
...
\verb|send()|, discussed in more depth in Section~\ref{sec:primitives}) makes 
