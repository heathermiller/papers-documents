...
calculus~\cite{TAPL}. Rules \textsc{T-Int} and \textsc{T-IntOp} assign
types to integer literals and applications of integer operators,
respectively.
