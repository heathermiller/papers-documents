...
\inferrule[\textsc{Proc-Req}] {
  ...
  process(h, {\Req {h'} r \iota}, \sigma) = (\epsilon, M, \highlight{\sigma'})
}
...
\inferrule[\textsc{Proc-ReqPersist}] {
  ...
  process(h, {\Req {h'} r \iota}, \sigma) = (\epsilon, \{ h' \leftarrow {\ResP \iota v {P'}} \}, \sigma'')
}

\inferrule[\textsc{Proc-Res}] {
  \sigma' = [\iota \mapsto \highlight{(v, P)}]\sigma
} {
  process(h, \highlight{{\ResP \iota v P}}, \sigma) = (\epsilon, \emptyset, \sigma')
}
\end{mathpar}
