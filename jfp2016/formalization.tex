...
\inferrule[\textsc{R-Process}] {
  \iota \notin dom(\sigma) \quad process(h, m, \sigma) = (t, M', \sigma')
} {
...
${\Req {h'} r \iota}$ and ${\Res \iota v}$. Handling a message of the
form ${\Res \iota v}$ is simple: it suffices to create an updated
store $\sigma'$ which maps $\iota$ to $v$ (rule \textsc{Proc-Res}).
