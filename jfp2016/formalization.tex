...
silo store typing $\Delta$ to be consistent with corresponding type of
spore $p$. Rule \textsc{WF-Ref3} requires the type of silo $\omega$ to
be equal to the type of its parent silo $id(r)$ in silo store typing
...
Rules \textsc{WF-SiloStore1-3} requires a well-formed silo store to be
