...
pickle extension method (see Section~\ref{sec:usage}). As a result, such an
...
\ref{sec:background}.} does not require changing the invocation in most
cases.
\todo when is it impossible to generate a TypeTag?
...
formally defined in the following Section \ref{sec:inheritance-model}
...
\todo Define what linearization means in the above definition!!
