...
\paragraph{Data types in distributed frameworks and applications}

Figure~\ref{fig:survey} shows a summary of the most important data
types used in popular distributed computing frameworks like
Spark~\cite{Spark} and Storm~\cite{Storm}. We categorize the data
...
The second group in the bottom half of Figure~\ref{fig:survey}
...
supports both, though). At least in one case (Twitter's Chill) a
framework explicitly serializes Manifests, type descriptor for Scala
