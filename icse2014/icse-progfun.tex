...
What sets the course apart from other MOOCs related to programming or software engineering is that it has enjoyed one of the highest completion rates (19.2\%) of any MOOC worldwide~\cite{Parr13}\footnote{At the time the first iteration of the course ended in November 2012. Today, it still has one of the highest rates of completion given its size~\cite{moocCompletionRates}.}. Completion rates of around 7\% are standard.
