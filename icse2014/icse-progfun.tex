...
(e.g., IDEs, or the automated grader) for making distance learning more effective.
...
The survey results on code editor usage in Figure~\ref{fig:ides} show that
80\% of all students prefer to use the Scala IDE for eclipse. For almost half
of those students, eclipse is not their preferred IDE for projects outside
the class. One feature that was only available in the Scala IDE for eclipse
