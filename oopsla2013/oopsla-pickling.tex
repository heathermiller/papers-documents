...
generating them at compile-time. While specifically
...
traditional applications migrate to the cloud, the demand for interopability between
...
method \term{unpickle} triggers static unpickler generation.
...
Using the Scala Pickling framework, it's
...
relevant.\footnote{With Kryo some of this overhead can be avoided when using custom, hand-written serializers.}
