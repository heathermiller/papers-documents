...
\begin{figure*}[ht!]
 ...
 \caption{Results for pickling/unpickling evactor datatypes, numerous tiny messages represented as case classes containing primitive fields.}
 \label{fig:evactor}
\end{figure*}
