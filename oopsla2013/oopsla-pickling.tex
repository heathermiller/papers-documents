...
In summary, the combination of invariant picklers and generics (with upper type bounds)
is flexible enough to support the outlined scenarios of unanticipated evolution. Since a similar 

support the above 

Given the advantages of invariant picklers 
