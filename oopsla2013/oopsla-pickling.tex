...
performance of our prototype is faster than Kryo for small to moderate-sized
collections, and is on par with Kryo or even slightly slower for large
...
detect that object identity does not have to be tracked in this case.
