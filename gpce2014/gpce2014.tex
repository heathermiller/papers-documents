...
terms of the generic function code.The use of Scala's type-safe macro
...
features when defining generic functions. Most DGP approaches 


Using this approach, we have implemented a full-featured serialization
framework for Scala. Full-featured in that it handles all
object-oriented concerns, such as subtyping polymorphism, object
identity, etc. As well as advanced features of the type system. This
is not a toy example. It's general!
