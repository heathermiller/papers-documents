...
\emph{after} the type or class has been defined. This is in constrast 
...
\subsection{Pretty Printing Complex Structures}
...
Scala, Scala 2.11.\footnote{Scala 2.11 is the current stable release of Scala
as of April 2014.} No extension of the Scala language or compiler is required
by the library. The library comprises around 2,700 LOC (including whitespace
...
become a non-experimental feature of a future Scala release.\footnote{Personal
