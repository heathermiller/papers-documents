...
\subsection{Informal description of simplified case}
...
\gap ~|~ & \texttt{case class}~C(p_1: D_1, \ldots, p_n: D_n)~\{~\bar{m}~\} \\
...
\begin{lstlisting}
var result: String = ""
val instance_1 = implicitly[Show[D_1]]
val result_1   = instance_1.show(visitee.p_1)
result         = result + result_1
...
val instance_n = implicitly[Show[D_n]]
val result_n   = instance_n.show(visitee.p_n)
