...
\end{lstlisting}
\noindent
Quasiquotes statically guarantee that quoted expressions are syntactically correct, but
the resulting trees are type-checked only once macro expansion returns.
