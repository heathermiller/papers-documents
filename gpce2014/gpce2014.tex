...
\begin{abstract}
  ...
  system extensions like an \emph{immutability checker}. However unlike
...
them. \footnote{BRUNO: I think there is too much detail here
...
specialized functionality~\cite{Pickling}.\footnote{BRUNO: Two important
...
generality.\footnote{BRUNO: I am not sure if this is a good way to promote this
  ...
  bullet points).} Scala/Pickling is a hybrid library/compile time-based
...
\item {\bf An approach supporting both generic functions and generic
  ...
  runtime, \eg immutability.\footnote{Bruno: I think here you should
...
in practice, we has been used to implement an industry-ready
