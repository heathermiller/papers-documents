...
\paragraph{Principles} In this work, we focus on one of two macro def
...
%   macro expansions.
 ...
 % -- one need not consider the macro's corresponding implementation in . One can reason about macros in an abstract way, independent of their implementation.
