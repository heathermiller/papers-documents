...
%
\titlerunning{RAY: Integrating Rx and Async for Direct-Style Reactive Streams}  % abbreviated title (for running head)
%                                     also used for the TOC unless
%                                     \toctitle is used
%
\author{Philipp Haller\inst{1} \and Heather Miller\inst{2}}
%
\authorrunning{Heather Miller et al.} % abbreviated author list (for running head)
%
%%%% list of authors for the TOC (use if author list has to be modified)
\tocauthor{Philipp Haller, and Heather Miller}
%
\institute{Typesafe, Switzerland\\
\and
EPFL, Switzerland}
