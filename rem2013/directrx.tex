...
{  L(y) = o_1 \\
   H_0(o_1) = \langle \texttt{Task}, state \mapsto running(\bar{F}, \bar{D}) \rangle \\
   \forall \langle {o_2}, q \rangle \in \bar{D}.~o_2 \neq o \\
   H_1 = H_0[o_1 \mapsto \langle \texttt{Task}, state \mapsto running(\aframe L {\texttt{x = y.GetResult();} \bar{s}} {a(o)} :: \bar{F}, \bar{D}) \rangle]
}
...
{  L(y) = o_1 \\
   ...
   H_1 = H_0[o_1 \mapsto \langle \texttt{Task}, state \mapsto running(\aframe L {\texttt{x = y.GetResult();} \bar{s}} {a(o)} :: \bar{F}, \bar{D} \setminus \{ \langle o, [] \rangle \}) \rangle]
}
{ \fsreducebreak {H_0} {\aframe L {\texttt{x = awaitNextOrDone(y);} \bar{s}} {a(o)} \circ FS}
    {H_1} {FS}
}
...
{  L(y) = o_1 \\
   ...
   H_1 = H_0[o_1 \mapsto \langle \texttt{Task}, state \mapsto running(\bar{F}, \bar{D'} \cup \{ \langle o, q \rangle \}) \rangle]
}
{ \fsreducebreak {H_0} {\aframe L {\texttt{x = awaitNextOrDone(y);} \bar{s}} {a(o)} \circ FS}
