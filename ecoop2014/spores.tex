...
methods, each of which take normal functions as arguments.\footnote{Lazy filtering is supported using the additional
...
Note that superfluous \verb|capture| expressions are not harmful. Thus, it is
legal to write:
...
This allows the use of \verb|capture| in a way that does not require users to
