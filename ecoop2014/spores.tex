...
parallel, concurrent, and distributed code is more tractable.\todo{I'd like to cite anything here, even a SO article}
This trend is evidenced by the rise of functionally-flav, monadic-style collections~\cite{JavaLambdas}, ~\cite{ScalaParColls} ~\cite{FlowPools}
