...
(functions)\todo{say something instead about closures}. 
...
the user, is quickly becoming obsolete. With the growing trend towards cloud
...
or streaming big data processing, evidence this trend.
...
asynchronous, reactive ways with other clients or services. \todo{maybe make a nod to open programming?}

At the same time, the functional programming paradigm has irrefutably gained
remarkable traction in recent years, as is evidenced by the ongoing trend of
traditionally object-oriented or imperative languages being extended with
functional features, such as Java~\cite{JavaLambdas},
C++~\cite{CplusplusLambas}, and \todo{add more}, as well as the measurable
popularity of functional programming massively online open courses
(MOOCs)~\cite{ICSEMOOCPaper} and perceived importance in empirical studies on
software developers~\cite{PLAdoption}\todo{check Leo's paper, add others}.

One reason for the rise in popularity of functional programming languages and features is the basic philosophy of , and the observation that this mode of reasoning about data in parallel, concurrent, and distributed code.
...
This paper takes a step towards more principled open programming through a new foundation for pickling in object- oriented languages.
