...
\item We demonstrate the practicality of spores (a) through an small empirical study using a collection of Scala programs, and (b) show the power of the guarantees spores provide through a case study of new distributed and concurrent frameworks that this safe foundation for migratable closures can enable.
