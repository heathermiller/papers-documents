...
Like a normal function, the type of a spore contains the parameter type(s) as
well as the return type. Unlike a normal function, however, the spore type
additionally contains information about \textit{captured} and
\textit{excluded} types. This information is represented as (potentially
abstract) \verb|Captured| and \verb|Excluded| type members of the base
\verb|Spore| type.
...
is itself a subtype of one of Scala's function types.
