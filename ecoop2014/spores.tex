...
or even have general, custom user-defined properties. Crucially, our system is
...
frameworks that this safe foundation for migratable closures facilitates.
...
% power of these guarantees through a case analysis of real-world distributed/concurrent
% frameworks that this safe foundation for migratable closures facilitates.
...
concurrent, distributed, or in an arbitrary setting where closures must be
controlled.
...
distributed, and other arbitrary scenarios; it additionally facilitates
verification of closure-heavy code, enables optimization opportunities, IDE
support and compiler transformations that can further simplify the use of safe
closures.

Finally, we demonstrate the practicality of our approach through a small
empirical study, and show that even without automatic conversions, inference
and synthesis (that is, at their highest verbosity), converting non-trivial
