...
by function application) has even lead to a number of imperative and  object-oriented 
...
step towards more principled distributed programming with functions we call
